    ...
    <div className="flex flex-col flex-1 w-full min-h-screen bg-accent-light font-sans">
      ...
      <nav className="flex items-stretch w-full shadow-md">
        ...
        <div className="flex-1 bg-white flex items-center px-4">
          <ul className="flex gap-2 md:gap-4 lg:gap-8 text-lg font-medium">
            {navLinks.map(link => (
              <li key={link.to}>
                <NavLink
                  to={link.to}
        ...
        <div className="flex items-center gap-4 px-6 bg-white border-l border-gray-100 relative">
          {user ? (
            ...
            <div className="flex items-center gap-2">
              <NavLink to="/login" className="font-semibold hover:underline text-primary">Login</NavLink>
              <NavLink to="/signup" className="font-semibold hover:underline text-primary">Sign Up</NavLink>
            </div>
          )}
        </div>
      </nav>
